/**
 * mistral.js — Mistral AI structured output service.
 *
 * Replaces Grok/xAI from PolyWhisper. Uses Mistral's JSON mode
 * to extract prediction-market signals from a live transcript chunk.
 */
...
const RESPONSE_SCHEMA = {
    ...
    properties: {
        detected: {
            type: 'boolean',
            description: 'Whether a betting/prediction market topic is being discussed'
        },
        queries: {
            type: 'array',
            items: { type: 'string' },
            description: '1-3 distinct keyword phrases optimised for Polymarket search, covering different angles of the topic'
        },
        tag: {
            type: 'string',
        ...
        reason: {
            type: 'string',
            description: 'Concise summary (max 20 words) of what is being discussed and why it could be a bet'
        }
    },
 ...
 * @returns {Promise<{ detected: boolean, queries: string[], tag: string|null, reason: string }>}
 */
